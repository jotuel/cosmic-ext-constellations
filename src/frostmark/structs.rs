...
use crate::frostmark::state::MarkState;
...
/// To render this, call `Into<cosmic::iced::Element<_>>`.
///
...
pub struct MarkWidget<'a, Message, Theme = cosmic::iced::Theme> {
    ...
    pub(crate) style: Option<crate::frostmark::Style>,
...
impl<'a, M: 'a, T: 'a> MarkWidget<'a, M, T> {
    ...
    ///             let mut i = cosmic::iced::widget::image(image.clone());
    ...
    ///
    /// impl App {
    ///     fn view(&self) -> cosmic::iced::Element<'_, Message> {
    ...
    /// in the document using [`crate::frostmark::Style`].
    #[must_use]
    pub fn style(mut self, style: crate::frostmark::Style) -> Self {
