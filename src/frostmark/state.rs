...
use crate::frostmark::structs::{UpdateMsg, UpdateMsgKind};
...
impl MarkState {
    ...
    /// from [`crate::frostmark::MarkWidget::on_updating_state`].
    ...
    /// 3. Handle the rendering of these images via [`crate::frostmark::MarkWidget::on_drawing_image`].
    #[must_use]
